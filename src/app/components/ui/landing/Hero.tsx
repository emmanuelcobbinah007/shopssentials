...
const Hero = () => {
    return (
        <div className="w-[90%] max-w-6xl mx-auto flex flex-col items-center justify-center h-[90vh] md:h-[80vh] px-4 mt-[60px]">
            <div>
            ...
            <input
                ...
                className="w-full px-6 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
            />
            <button
